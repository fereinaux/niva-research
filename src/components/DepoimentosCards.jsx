...
const DepoimentosCards = () => {
  return (
    <>
      {/* Card 1 */}
      <div className="w-full flex-shrink-0 px-4">
        <div className="bg-blue-50/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="text-center">
            <div className="w-16 h-16 bg-gradient-to-br from-[#1595FF] to-[#0D7AE8] rounded-full mx-auto mb-6 flex items-center justify-center">
              <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
              </svg>
            </div>
            <h4 className="text-lg font-semibold text-[#282828] mb-2">Cíntia Miekusz</h4>
            <p className="text-sm text-[#282828]/70 mb-4">Group Product Manager | Produtos Financeiros</p>
            <p className="text-[#282828]/80 italic leading-relaxed">
      ...
      <div className="w-full flex-shrink-0 px-4">
        <div className="bg-blue-50/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="text-center">
            <div className="w-16 h-16 bg-gradient-to-br from-[#FF6339] to-[#E55A2B] rounded-full mx-auto mb-6 flex items-center justify-center">
              <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"/>
              </svg>
            </div>
            <h4 className="text-lg font-semibold text-[#282828] mb-2">Carla Borba</h4>
            <p className="text-sm text-[#282828]/70 mb-4">Professora Universitária | UFPE</p>
            <p className="text-[#282828]/80 italic leading-relaxed">
      ...
      <div className="w-full flex-shrink-0 px-4">
        <div className="bg-blue-50/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-[#282828] mb-2">Regina Fialho</h4>
            <p className="text-sm text-[#282828]/70 mb-4">UX Specialist</p>
            <p className="text-[#282828]/80 italic leading-relaxed">
      ...
      <div className="w-full flex-shrink-0 px-4">
        <div className="bg-blue-50/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-[#282828] mb-2">Carol Andrade</h4>
            <p className="text-sm text-[#282828]/70 mb-4">Group Product Manager @frete.com</p>
            <p className="text-[#282828]/80 italic leading-relaxed">
      ...
      <div className="w-full flex-shrink-0 px-4">
        <div className="bg-blue-50/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-[#282828] mb-2">Júlia Piovesan</h4>
            <p className="text-sm text-[#282828]/70 mb-4">Insights & Marketing</p>
            <p className="text-[#282828]/80 italic leading-relaxed">
      ...
      <div className="w-full flex-shrink-0 px-4">
        <div className="bg-blue-50/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-[#282828] mb-2">Bruno Queirós</h4>
            <p className="text-sm text-[#282828]/70 mb-4">Senior Product Designer @frete.com</p>
            <p className="text-[#282828]/80 italic leading-relaxed">
      ...
      <div className="w-full flex-shrink-0 px-4">
        <div className="bg-blue-50/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-[#282828] mb-2">Carla Cardoso dos Santos</h4>
            <p className="text-sm text-[#282828]/70 mb-4">Pesquisa de Mercado</p>
            <p className="text-[#282828]/80 italic leading-relaxed">
      ...
      <div className="w-full flex-shrink-0 px-4">
        <div className="bg-blue-50/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-[#282828] mb-2">Elisângela Farias</h4>
            <p className="text-sm text-[#282828]/70 mb-4">Docente e Consultora</p>
            <p className="text-[#282828]/80 italic leading-relaxed">
      ...
      <div className="w-full flex-shrink-0 px-4">
        <div className="bg-blue-50/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-[#282828] mb-2">Kauê Oliveira Mender</h4>
            <p className="text-sm text-[#282828]/70 mb-4">UX Researcher</p>
            <p className="text-[#282828]/80 italic leading-relaxed">
      ...
      <div className="w-full flex-shrink-0 px-4">
        <div className="bg-blue-50/90 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-[#282828] mb-2">Tharine Santana</h4>
            <p className="text-sm text-[#282828]/70 mb-4">Staff Product Designer @stone</p>
            <p className="text-[#282828]/80 italic leading-relaxed">
...
export default DepoimentosCards;
