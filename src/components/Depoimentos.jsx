  ...
  return (
    <section id="depoimentos" className="min-h-screen bg-gradient-to-br from-white via-[#FFF3E1] to-white flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto text-center px-2 sm:px-4 md:px-6 lg:px-8 relative z-10 w-full">
        ...
        {/* Card CTA LinkedIn */}
        <div className="mt-24 mb-24 animate-fade-in-up animate-delay-600">
          <div className="bg-gradient-to-br from-white/80 to-white/60 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-lg hover:shadow-xl transition-all duration-300 max-w-2xl mx-auto border border-white/20 relative overflow-hidden">
            {/* Decorative elements */}
            <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-[#1595FF]/10 to-transparent rounded-full -translate-y-10 translate-x-10"></div>
            <div className="absolute bottom-0 left-0 w-16 h-16 bg-gradient-to-tr from-[#FF6339]/10 to-transparent rounded-full translate-y-8 -translate-x-8"></div>
            
            <div className="text-center text-[#282828] relative z-10">
              {/* Icon */}
              <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-[#1595FF] to-[#0D7AE8] rounded-full shadow-md mb-4">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                </svg>
              </div>
              
              <h3 className="text-lg md:text-xl font-bold mb-3 text-[#282828]">
                Quer ver mais recomendações?
              </h3>
              
              <p className="text-sm md:text-base mb-6 leading-relaxed text-[#282828]/80">
                Acesse o perfil completo da <span className="text-[#1595FF] font-semibold">Delly</span>, fundadora da Niva, no LinkedIn.
              </p>
              ...
              <a 
                ...
                className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-[#1595FF] to-[#0D7AE8] hover:from-[#0D7AE8] hover:to-[#1595FF] rounded-full transition-all duration-300 transform hover:scale-110 shadow-lg hover:shadow-xl"
              >
