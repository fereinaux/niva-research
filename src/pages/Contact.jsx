...
function Contact() {
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-emerald-200 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent"
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent"
                  required
                >
      ...
      case 2:
        return (
          <div className="space-y-8">
            <div>
              <label className="block text-emerald-100 text-sm font-semibold mb-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full px-4 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-emerald-200 focus:outline-none focus:ring-2 focus:ring-emerald-400 focus:border-transparent resize-none"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-white">
      ...
      {/* Section 2 - Footer */}
      <section className="py-16 bg-gradient-to-br from-slate-900 via-emerald-900 to-teal-900 relative overflow-hidden">
        {/* Background Elements */}
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 mb-8">
              <a 
                ...
                className="group flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all duration-300 hover:scale-105"
              >
                ...
                <span className="text-emerald-100 group-hover:text-white transition-colors font-medium">Email</span>
              </a>
              ...
              <a 
                ...
                className="group flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 hover:bg-white/20 hover:border-white/30 transition-all duration-300 hover:scale-105"
              >
                <svg className="w-5 h-5 text-emerald-300 group-hover:text-emerald-200 transition-colors" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-emerald-100 group-hover:text-white transition-colors font-medium">WhatsApp</span>
              </a>
              ...
              >
                ...
                <span className="text-emerald-100 group-hover:text-white transition-colors font-medium">Instagram</span>
              </a>
              ...
              >
                ...
                <span className="text-emerald-100 group-hover:text-white transition-colors font-medium">LinkedIn</span>
              </a>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 max-w-2xl mx-auto">
              <div className="flex items-center justify-center gap-3 mb-3">
                ...
                <span className="text-emerald-100 font-medium">Recife, PE</span>
              </div>
